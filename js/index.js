...
import {SpatialMesh} from './spatial-mesh.js';
...
const Constants = {
    ProjectName: 'SpatialMesh.wlp',
    RuntimeBaseName: 'WonderlandRuntime',
    WebXRRequiredFeatures: ['local','plane-detection','mesh-detection'],
...
engine.registerComponent(SpatialMesh);
